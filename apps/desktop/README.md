...
- 下一步建议围绕 HTTP-like sync transport 增加本地错误可见性或真实 HTTP transport contract；real HTTP transport remains later，当前仍先保持 in-memory transport 和 HTTP-like router 语义验证。
